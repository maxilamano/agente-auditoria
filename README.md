...
Con esto también necesitas multiples paquetes de python, los puedes instalar en PowerShell con:
...
También necesitarás OLLAMA para gestionar el modelo de IA, lo puedes instalar usando PowerShell con el siguiente comando:
